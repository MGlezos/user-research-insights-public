            ...
            {!isApiKeyStored ? (
              <div className="flex gap-2">
                <Input
                  ...
                  className="w-[200px] h-9 px-3 border-[#E5E7EB] rounded-[8px] focus:border-[#01A0A9] focus:ring-[#01A0A9] text-[#1B1823] text-sm"
                />
                <Button
              ...
              <div className="flex items-center gap-2 h-9 px-3 border border-[#E5E7EB] rounded-[8px] bg-[#FFFFFF] w-[200px]">
