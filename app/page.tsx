...
import { Loader2, Upload, FileAudio, Download, X, Check, Info } from "lucide-react"
import {
  storeApiKey,
  retrieveApiKey,
  clearApiKey,
      ...
      <div className="border-b border-[#E5E7EB] bg-[#F7F9F8]">
        <div className="px-8 py-4 flex items-center gap-8">
          ...
          <div className="flex flex-col gap-1">
            <Label className="text-[#1B1823] text-sm font-medium">Voice to Text</Label>
            {!isApiKeyStored ? (
              <div className="flex gap-2">
                <Input
                  ...
                  className="w-[100px] h-9 px-3 border-[#E5E7EB] rounded-[8px] focus:border-[#01A0A9] focus:ring-[#01A0A9] text-[#1B1823] text-sm"
                />
                <Button
              ...
              <div className="flex items-center gap-2 h-9 px-3 border border-[#E5E7EB] rounded-[8px] bg-[#FFFFFF] w-[100px]">
                <span className="text-[#1B1823] text-sm flex-1">...{storedApiKey.slice(-4)}</span>
                <a
          ...
          {/* AI Summary Section */}
          <div className="flex flex-col gap-1">
            <Label className="text-[#1B1823] text-sm font-medium">AI Summary</Label>
            {!isGeminiKeyStored ? (
              <div className="flex gap-2">
                <Input
                  id="geminiKey"
              ...
              <div className="flex items-center gap-2 h-9 px-3 border border-[#E5E7EB] rounded-[8px] bg-[#FFFFFF] w-[100px]">
                <span className="text-[#1B1823] text-sm flex-1">...{storedGeminiKey.slice(-4)}</span>
                <a
